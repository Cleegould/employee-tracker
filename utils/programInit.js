...
function viewEmployeesByDept() {
    const getDepartments = new Promise((req, res) => {
        var departmentsArr = [];
...
function addEmployee() {
  ...
  const getTitles = new Promise((req, res) => {
    var titlesArr = [];
  ...
  const getActiveManagerList = new Promise((req, res) => {
    ...
    db.query(sql, (err, rows) => {
      ...
      req(activeManagerArr);
    });
  });

  const getManagerList = new Promise((req, res) => {
    var managerArr = [];
  ...
  const getManIdList = new Promise((req, res) => {
    var manIdArr = [];
...
function updateEmployee() {
  ...
  const getEmployees = new Promise((req, res) => {
    var employeesArr = [];
